...
function updateCounts() {
    ...
    const annotationCount = $("annotationCount");
    ...
    if (selectedObject) {
        selectedObject.textContent = state.selectedId ? "1" : "0";
    }

    if (selectedCount) {
        selectedCount.textContent = state.selectedId
            ? "1 selected"
            : "0 selected";
    }
